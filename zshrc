...
#export PATH=$HOME/work/riscv-openocd-0.10.0-2020.12.1-x86_64-linux-ubuntu14/bin:$PATH
...
# was loaded, run: echo $RANDOM_THEME
...
#
#
alias doneding='( speaker-test -t sine -f 1000)& pid=$! ; sleep 0.5s ; kill -9 $pid > /dev/null'
